...
def fit_model():
    ...
    numerical_features = ['total_area', 'living_area', 'kitchen_area', 'rooms', 'floor', 'build_year', 'ceiling_height', 'flats_count', 'floors_total', 'latitude', 'longitude']
    categorical_features = ['building_type', 'has_elevator', 'is_apartment', 'studio']
